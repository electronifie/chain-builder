 ...
 */
Logger.prototype.chainStart = function (parentChainStartMemo) {
 ...
 */
Logger.prototype.callStart = function (chainStartMemo, callDescriptor) {
  if (this.isDisabled) return null;
...
/**
 * @typedef {{ instanceId: String, depth: Number, parentChainInstanceId: (String|null) }} Logger.ChainStartDetails
 */

/**
 * @typedef {{ instanceId: String, depth: Number, parentChainInstanceId: (String|null), runTime: Number }} Logger.ChainEndDetails
 */

/**
 * @typedef {{ instanceId: String, depth: Number, chainInstanceId: String, methodName: String }} Logger.CallStartDetails
 */

/**
 * @typedef {{ instanceId: String, depth: Number, chainInstanceId: String, methodName: String, runTime: Number }} Logger.CallEndDetails
 */

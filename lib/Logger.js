...
Logger.prototype.callStart = function (chainStartMemo, callDescriptor, evaluatedArgs, method) {
  ...
  var details = {
    ...
    method: method,
    callStack: callDescriptor.stack
  };
 ...
 * @param {*} result
 */
Logger.prototype.callEnd = function (callStartMemo, callDescriptor, execStack, error, result) {
  if (this.isDisabled) return;
...
/**
 * @typedef {{ instanceId: String, depth: Number, chainInstanceId: String, methodName: String, args: *[], evaluatedArgs: *[], callStack: String[], execStack: String[] }} Logger.CallStartDetails
 */

/**
 * @typedef {{ instanceId: String, depth: Number, chainInstanceId: String, methodName: String, runTime: Number, result: *, error: *, callStack: String[], execStack: String[] }} Logger.CallEndDetails
 */

/**
 * @typedef {{ methodName: String, depth: Number, stack: String[] }} Logger.CallSkippedDetails
 */

 ...
 * @callback LogHandler
 * @description
 *   A method for receiving log events.
 * @property {Boolean}         $logHandler - (should be 'true') identifies the method as a log handler
 * @param    {Logger.LogEvent} eventName   - the type of event to handle
